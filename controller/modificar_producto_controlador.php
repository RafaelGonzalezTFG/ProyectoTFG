...
if (
    ...
    $resultado = $gestorProduct->modificarProducto($producto, $categorias, $proveedores, $conexPDO);

    if ($resultado) {
        $mensaje = "Se ha modificado el producto con éxito";
    } else {
        $mensaje = "Se ha producido un error, se cancela la modificacion del producto";
    }
    //Paginacion
    ...
    // Establecemos la acción como "modificar" para mostrar el formulario correspondiente
    $accion = "modificar";
