...
<head>
    ...
    <link rel="stylesheet" href="../sass/estiloModificarProducto.css">
</head>
...
<body>
    ...
    <main class="contenidoPrincipal py-5">
        <div class="container">
            ...
            <div class="d-flex justify-content-center">
                <form method="POST" action="../controller/modificar_producto_controlador.php" class="w-75" enctype="multipart/form-data">
                    <input type="hidden" name="idProductos" value="<?php echo htmlspecialchars($datosProducto['idProductos'], ENT_QUOTES, 'UTF-8'); ?>" />
                    <input type="hidden" name="ImagenActual" value="<?php echo htmlspecialchars($datosProducto['Imagen'], ENT_QUOTES, 'UTF-8'); ?>" />

                    <div class="form-group row mb-3">
                        <label for="Nombre" class="col-lg-3 col-form-label">Nombre del producto:</label>
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="Nombre" name="Nombre" placeholder="Introduzca el Nombre" value="<?php echo htmlspecialchars($datosProducto['Nombre'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" id="Descripcion" name="Descripcion" placeholder="Introduzca la descripci&oacute;n"><?php echo htmlspecialchars($datosProducto['Descripcion'], ENT_QUOTES, 'UTF-8'); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="number" class="form-control" id="Peso" name="Peso" placeholder="Introduzca el peso en gramos" value="<?php echo htmlspecialchars($datosProducto['Peso'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="Material" name="Material" placeholder="Introduzca el material" value="<?php echo htmlspecialchars($datosProducto['Material'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" id="Marca" name="Marca" placeholder="Introduzca la marca" value="<?php echo htmlspecialchars($datosProducto['Marca'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                            ...
                            <select name="Proveedores" id="Proveedores" class="form-control">
                                ...
                                if (empty($datosProveedores)) {
                                    ...
                                    foreach ($datosProveedores as $proveedor) {
                                        $selected = $proveedor["idProveedores"] == $datosProducto["idProveedores"] ? "selected" : "";
                                        echo "<option value='" . htmlspecialchars($proveedor["idProveedores"], ENT_QUOTES, 'UTF-8') . "' $selected>" . htmlspecialchars($proveedor["Nombre"], ENT_QUOTES, 'UTF-8') . "</option>";
                                    }
                                }
                                ?>
                            </select>
                                ...
                                if (empty($datosCategorias)) {
                                    ...
                                    foreach ($datosCategorias as $categorias) {
                                        if ($categorias["idCategorias"] > 16) {
                                            $selected = $categorias["idCategorias"] == $datosProducto["idCategorias"] ? "selected" : "";
                                            echo "<option value='" . htmlspecialchars($categorias["idCategorias"], ENT_QUOTES, 'UTF-8') . "' $selected>" . htmlspecialchars($categorias["Nombre"], ENT_QUOTES, 'UTF-8') . "</option>";
                                        }
                                    }
                                }
                                ?>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="number" class="form-control" id="Precio" name="Precio" placeholder="Introduzca el precio" step="0.01" value="<?php echo htmlspecialchars($datosProducto['Precio'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="number" class="form-control" id="Stock" name="Stock" placeholder="Introduzca el stock disponible" value="<?php echo htmlspecialchars($datosProducto['Stock'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="date" class="form-control" id="FechaAdquisicion" name="FechaAdquisicion" value="<?php echo htmlspecialchars($datosProducto['FechaAdquisicion'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <input type="date" class="form-control" id="FechaCaducidad" name="FechaCaducidad" value="<?php echo htmlspecialchars($datosProducto['FechaCaducidad'], ENT_QUOTES, 'UTF-8'); ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-lg-9">
                            <img id="imagenActual" src="../img/imagenesSubidas/<?php echo htmlspecialchars($datosProducto['Imagen'], ENT_QUOTES, 'UTF-8'); ?>" alt="Imagen Actual" class="img-small" />
                            <input type="file" class="form-control mt-2" id="Imagen" name="Imagen" accept=".jpg, .jpeg, .png" onchange="previewImage(event)" />
                        </div>
                    </div>
